...
function produtoCalcaFeminina ({ navigation }) {
  return (
    <ScrollView>
      <View>
        <Header1 />
      ...
      <View style={main.align1}>
        <Text />
        <Image style={main.product1} source={require('../../images/calcaFeminina.webp')} />
      </View>
      <View style={main.align2}>
        <Text />
        <Text style={main.productTitle}>Calça Jeans</Text>
        <Text />
        ...
        <Text />
        <Text style={main.productPrice}>R$ 80,00</Text>
        <Text />
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity>
...
export default produtoCalcaFeminina
