...
function produtoCasacoFeminino ({ navigation }) {
  return (
    <ScrollView>
      <View>
        <Header1 />
      ...
      <View style={main.align1}>
        <Text />
        <Image style={main.product1} source={require('../../images/casacoFeminino.webp')} />
      </View>
      <View style={main.align2}>
        <Text />
        <Text style={main.productTitle}>Casaco Trench Coat</Text>
        <Text />
...
export default produtoCasacoFeminino
