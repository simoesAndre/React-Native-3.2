...
function produtoVestido ({ navigation }) {
  return (
    <ScrollView>
      <View>
        <Header1 />
      ...
      <View style={main.align1}>
        <Text />
        <Image style={main.product1} source={require('../../images/vestido.webp')} />
      </View>
      <View style={main.align2}>
        <Text />
        <Text style={main.productTitle}>Vestido Estampado</Text>
        <Text />
        ...
        <Text />
        <Text style={main.productPrice}>R$ 60,00</Text>
        <Text />
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity>
